...
const ProductCard = ({product, tallSlide, listView, specialStyles}) => {
    ...
    const ratingColor = useCallback((ratingValue) => {
        ...
        <>
            <div className={`${styles.productWrapper} ${listView ? styles.listView : ""}`}>
                <div className={styles.productsContainerBox}>
                    <div
                        className={`${styles.productImage} ${tallSlide ? styles.tallSlide : ""} ${specialStyles ? styles.specialImage : null}`}>
                    ...
                    <div className={styles.productText}>
                        ...
                        <span className={styles.priceContainer}>{currencyState === "azn" ? "AZN" : "$"} {currencyConverter(product.salePrice)?.toFixed(2)}
